...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BoardGame>(entity =>
        {
            ...
            entity.HasMany(d => d.Categories).WithMany(p => p.BoardGames)
                .UsingEntity<Dictionary<string, object>>(
                    "BoardGameCategory",
                    r => r.HasOne<Category>().WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__board_gam__categ__0D7A0286"),
                    l => l.HasOne<BoardGame>().WithMany()
                        .HasForeignKey("BoardGameId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__board_gam__board__0C85DE4D"),
                    j =>
                    {
                        j.HasKey("BoardGameId", "CategoriesId").HasName("PK__board_ga__06BBB62688C8A37E");
                        j.ToTable("board_game_categories");
            ...
            entity.HasMany(d => d.Mechanics).WithMany(p => p.BoardGames)
                .UsingEntity<Dictionary<string, object>>(
                    "BoardGameMechanic",
                    r => r.HasOne<Mechanic>().WithMany()
                        .HasForeignKey("MechanicsId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__board_gam__mecha__1332DBDC"),
                    l => l.HasOne<BoardGame>().WithMany()
                        .HasForeignKey("BoardGameId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__board_gam__board__123EB7A3"),
                    j =>
                    {
                        j.HasKey("BoardGameId", "MechanicsId").HasName("PK__board_ga__482AACDFA8135295");
                        j.ToTable("board_game_mechanics");
                        j.IndexerProperty<int>("BoardGameId").HasColumnName("board_game_id");
                        j.IndexerProperty<int>("MechanicsId").HasColumnName("mechanics_id");
                    });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__categori__3213E83F0C4E1A39");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__mechanic__3213E83FE9B87697");

            entity.ToTable("mechanics");

            entity.HasIndex(e => e.Name, "UX_mechanics_name").IsUnique();
